# Model dynamics of Wilson-Cowan model
# The Wilson and Cowan model describes the dynamics and interaction 
# between the excitatory and inhibitory population of neurons.

# Refer to https://senselab.med.yale.edu/ModelDB/showModel.cshtml?model=76879&file=/WC/wc.mod#tabs-1

# python3 WilsonCowan.py -wee 10. -wei 12. -wie 8. -wii 3. -ze 0.2 -zi 4. -ie1 0 -ii1 0 -w 0.25
# python3 WilsonCowan.py -wee 10. -wei 12. -wie 8. -wii 3. -ze 0.2 -zi 4. -ie1 0.5 -ii1 0.5 -w 0.25
# python3 WilsonCowan.py -wee 20. -wei 21. -wie 16. -wii 6 -ze 1.6 -zi 7. -ie1 0 -ii1 0 -w 0.25
# python3 WilsonCowan.py -wee 10. -wei 9. -wie 5. -wii 3 -ze 3 -zi 4. -ie1 0 -ii1 0 -w 0.25
