...
# ============ plot ==============
evenly_spaced_interval = np.linspace(0, 1, len(syn_pert_nexus_params["onset"]))
...
for imax in syn_pert_nexus_params["imax"]:
    for tau0 in syn_pert_nexus_params["tau0"]:
        for tau1 in syn_pert_nexus_params["tau1"]:
            for i, onset in enumerate(syn_pert_nexus_params["onset"]):
...
for imax in syn_pert_nexus_params["imax"][1:]:
    for tau0 in syn_pert_nexus_params["tau0"]:
        for tau1 in syn_pert_nexus_params["tau1"]:
            for i, onset in enumerate(syn_pert_nexus_params["onset"]):
