...
ts_nexus_pert = cfg_fig_9_3["sim"]["ts_nexus_pert"]
amp_nexus_syn_pert = cfg_fig_9_3["sim"]["amp_nexus_syn_pert"]
mul_Cas = cfg_fig_9_3["sim"]["mul_Ca"]
...
for mul_Ca in mul_Cas:
    ...
    toc = time.time()
    print(f'finished mul_Ca {mul_Ca}, {toc - tic} seconds')
...
for mul_Ca in mul_Cas:
    ...
    soma_v_np = dic_log[mul_Ca]['v_soma_t']
    nexus_v_np = dic_log[mul_Ca]['v_nexus_t']
...
list_n_sp = []
for mul_Ca in mul_Cas:
    n_sp = props[mul_Ca]['n_sp']
    gCa_HVAbar = dic_log[mul_Ca]['gCa_HVAbar']
